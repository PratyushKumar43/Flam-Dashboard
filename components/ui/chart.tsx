...
// Simplified ChartContainer - no longer depends on recharts
...
// Simplified tooltip components - no longer depend on recharts
...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    const value = typeof label === "string" && label in config
